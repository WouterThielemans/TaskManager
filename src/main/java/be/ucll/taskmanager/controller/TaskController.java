...
public class TaskController {
    ...
    public String createNewTask(@ModelAttribute @Valid TaskDTO task, BindingResult bindingResult){
    ...
    public String postEditTask(@PathVariable("id") UUID id, Model model, @ModelAttribute @Valid TaskDTO task){
    ...
    public String createSubTaskPost(@ModelAttribute SubTaskDTO subtask, @PathVariable("id") UUID id, Model model, BindingResult bindingResult){
        if(bindingResult.hasErrors()){
            return "tasksubtask";
        }
